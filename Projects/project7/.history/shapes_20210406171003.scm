                        ...
                        (cond 
                            ...
                            ((equal? (list-ref args 0) "min")
                                (begin
                                    ...
                                    (display (findMinArea (wash (read-file (list-ref args 1)))))
                                    (newline)
                                    (display "min(Volume)=")
                                    (display (findMinVolume (wash (read-file (list-ref args 1)))))
                                    (newline)
                                )
                            )
                            ((equal? (list-ref args 0) "max")
                                (begin
                                    ...
                                    (display (findMaxArea (wash (read-file (list-ref args 1)))))
                                    (newline)
                                    (display "max(Volume)=")
                                    (display (findMaxVolume (wash (read-file (list-ref args 1)))))
                                    (newline)
                                )
                            )
